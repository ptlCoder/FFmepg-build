...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-avdevice --enable-avcodec --enable-avformat --enable-gpl --disable-encoders --enable-libx264 --enable-encoder=libx264 --enable-encoder=mjpeg --enable-encoder=png --extra-cflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode' --extra-ldflags='-arch arm64 -mios-version-min=8.0 -fembed-bitcode' --extra-cflags=-I/Users/soliloquy/Desktop/test-FFmpeg/X264/thin-x264/arm64/include --extra-ldflags=-L/Users/soliloquy/Desktop/test-FFmpeg/X264/thin-x264/arm64/lib --prefix=/Users/soliloquy/Desktop/test-FFmpeg/ptl-ffmpegLib-x264-ios/arm64
prefix=/Users/soliloquy/Desktop/test-FFmpeg/ptl-ffmpegLib-x264-ios/arm64
...
CFLAGS=  -arch arm64 -mios-version-min=8.0 -fembed-bitcode -I/Users/soliloquy/Desktop/test-FFmpeg/X264/thin-x264/arm64/include -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch arm64 -mios-version-min=8.0 -fembed-bitcode -I/Users/soliloquy/Desktop/test-FFmpeg/X264/thin-x264/arm64/include -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch arm64 -mios-version-min=8.0 -fembed-bitcode -L/Users/soliloquy/Desktop/test-FFmpeg/X264/thin-x264/arm64/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -liconv -lm -framework AudioToolbox -lz -lx264 -pthread -lm -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
