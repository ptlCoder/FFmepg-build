...
extralibs_avcodec="-pthread -liconv -lm -framework AudioToolbox -lz -lx264 -pthread -lm -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo"
